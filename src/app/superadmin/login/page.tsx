...
function pickMessage(data?: LoginResponse) {
    if (!data) return "";
    return (
        data.message ||
        data.msg ||
...
function isSuccess(data?: LoginResponse) {
    const s = data?.status;
        ...
        <section className="min-h-screen bg-linear-to-br from-primary to-secondary text-black flex items-center justify-center px-4 py-10">
            <div className="w-full max-w-sm rounded-2xl bg-white/90 backdrop-blur p-6 shadow-lg border border-white/30">
                ...
                <div className="mt-5 text-center">
                    ...
                    <p className="mt-1 text-sm text-black/60">Sign in with your mobile & password.</p>
                </div>
                ...
                <form onSubmit={onSubmit} className="mt-6 space-y-4">
                    ...
                    <div className="flex items-center justify-end">
                        <Link href="/superadmin/forgot-password" className="text-sm font-medium text-primary hover:underline">
                            Forgot password?
                        </Link>
                    </div>
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full rounded-xl bg-primary px-4 py-3 font-semibold text-white hover:bg-secondary hover:opacity-95 active:opacity-90 disabled:opacity-60 disabled:cursor-not-allowed"
                    >
