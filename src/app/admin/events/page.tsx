...
//   bannerUrl?: string; // for dummy preview
//   galleryCount?: number;
//   createdAt: string;
// };
...
//       if (editItem.paidMode === "online" && !editItem.onlineInfo) return alert("Please enter Online Payment Info");
//       if (editItem.paidMode === "offline" && !editItem.offlineInfo) return alert("Please enter Offline Payment Info");
//     }
...
//                         <p className="font-semibold truncate max-w-[280px]">{e.title}</p>
//                         <p className="text-xs text-black/50">ID: {e.id} • Gallery: {e.galleryCount ?? 0}</p>
//                       </div>
//                     </td>
...
//                       {e.paymentType === "free" ? (
//                         <span className="inline-flex rounded-full border border-black/10 bg-black/[0.02] px-3 py-1 text-xs font-semibold">
//                           Free
//                         </span>
//                       ) : (
//                         <span className="inline-flex rounded-full border border-black/10 bg-black/[0.02] px-3 py-1 text-xs font-semibold">
...
//               <input type="date" value={item.startDate} onChange={(e) => onChange({ ...item, startDate: e.target.value })} className={`${inputCls} mt-2`} />
//             </div>

//             <div>
//               <label className={labelCls}>Time *</label>
//               <input type="time" value={item.time} onChange={(e) => onChange({ ...item, time: e.target.value })} className={`${inputCls} mt-2`} />
//             </div>

//             <div className="lg:col-span-2">
//               <label className={labelCls}>Description *</label>
//               <textarea rows={4} value={item.description} onChange={(e) => onChange({ ...item, description: e.target.value })} className={`${inputCls} mt-2 resize-none`} />
//             </div>
...
//               <input value={item.state} onChange={(e) => onChange({ ...item, state: e.target.value })} className={`${inputCls} mt-2`} />
//             </div>

//             <div>
//               <label className={labelCls}>City *</label>
//               <input value={item.city} onChange={(e) => onChange({ ...item, city: e.target.value })} className={`${inputCls} mt-2`} />
//             </div>

//             <div className="lg:col-span-2">
//               <label className={labelCls}>Status</label>
//               <select value={item.status} onChange={(e) => onChange({ ...item, status: e.target.value as ShowStatus })} className={`${inputCls} mt-2`}>
//                 <option value="Upcoming">Upcoming</option>
//                 <option value="Draft">Draft</option>
//                 <option value="Completed">Completed</option>
//               </select>
...
//             <div className="lg:col-span-2 rounded-2xl border border-black/10 bg-black/[0.02] p-4">
...
//                     onChange={() => onChange({ ...item, paymentType: "paid", paidMode: item.paidMode || "online" })}
//                   />
//                   Paid
//                 </label>
//               </div>
...
//                     <input type="number" min={0} value={item.ticketPrice || ""} onChange={(e) => onChange({ ...item, ticketPrice: e.target.value })} className={`${inputCls} mt-2`} />
//                   </div>

//                   <div>
//                     <label className={labelCls}>Ticket Count</label>
//                     <input type="number" min={0} value={item.ticketCount || ""} onChange={(e) => onChange({ ...item, ticketCount: e.target.value })} className={`${inputCls} mt-2`} />
//                   </div>
...
//                       <label className="flex items-center gap-2 rounded-xl border border-black/15 bg-white px-3 py-2 text-sm">
//                         <input type="radio" name="paidModeEdit" checked={(item.paidMode || "online") === "online"} onChange={() => onChange({ ...item, paidMode: "online" })} />
//                         Online
//                       </label>

//                       <label className="flex items-center gap-2 rounded-xl border border-black/15 bg-white px-3 py-2 text-sm">
//                         <input type="radio" name="paidModeEdit" checked={item.paidMode === "offline"} onChange={() => onChange({ ...item, paidMode: "offline" })} />
//                         Offline
//                       </label>
//                     </div>
...
//                         <input value={item.onlineInfo || ""} onChange={(e) => onChange({ ...item, onlineInfo: e.target.value })} className={`${inputCls} mt-2`} placeholder="UPI / link / instructions" />
//                       </div>
//                     ) : (
//                       <div className="mt-4">
//                         <label className={labelCls}>Offline Payment Info *</label>
//                         <input value={item.offlineInfo || ""} onChange={(e) => onChange({ ...item, offlineInfo: e.target.value })} className={`${inputCls} mt-2`} placeholder="Pay at venue/counter" />
//                       </div>
//                     )}
//                   </div>
//                 </div>
...
//           <button type="button" onClick={onClose} className="rounded-xl border border-black/10 bg-white px-5 py-3 text-sm font-semibold hover:bg-black/5">
//             Cancel
//           </button>

//           <button type="button" onClick={onUpdate} className="rounded-xl bg-primary px-5 py-3 text-sm font-semibold text-white hover:opacity-95">
//             Update Event
//           </button>
//         </div>
//       </div>
