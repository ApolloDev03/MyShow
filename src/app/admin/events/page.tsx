...
//   /** ✅ pay mode (if backend sends) */
//   paid_mode?: PaidMode | null;
//   payment_mode?: PaidMode | null;
...
//         console.log(x.payment_mode, "xxxxxxx")
...
//           paidMode: x.payment_mode === 1 ? "online" : "offline",
...
//       const paidMode = (ev.paid_mode || ev.payment_mode || row.paidMode || "online") as PaidMode;
...
//   /** ✅ UPDATE API (time + banner + photos + paymode) */
...
//           /** ✅ FIXED: payment_mode 1/2 -> online/offline */
...
//         /** ✅ FIXED: UI online/offline -> API 1/2 */
