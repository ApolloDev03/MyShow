...
//     // ✅ NEW: if user removes existing photo during edit
...
//             if (!ensureTokenOrError()) return null;
//             const res = await axios.post(
//                 `${apiUrl}/admin/group-members/edit/${id}`,
//                 {},
//                 authConfig()
//             );
...
//         const res = await axios.post(
//             `${apiUrl}/admin/group-members/store`,
//             fd,
//             authConfig()
//         );
//         return res.data;
...
//         // ✅ If user selected new photo, send file
//         console.log(photoFile,"photofile")
//         if (photoFile) {
//             fd.append("photo", photoFile);
//         }
//         // ✅ If no removePhoto and no photoFile => don't send photo => keep old

//         const res = await axios.post(
//             `${apiUrl}/admin/group-members/update/${id}`,
//             fd,
//             authConfig()
//         );
//         return res.data;
...
//                                         <td className="px-4 py-3">
//                                             <div className="min-w-0">
//                                                 <p className="max-w-65 truncate font-semibold">
//                                                     {m.name}
//                                                 </p>
//                                             </div>
//                                         </td>
...
//                                             setPhotoFile(file);
//                                             if (file) {
//                                                 // ✅ if user selects file after removing photo, cancel remove
//                                                 setRemovePhoto(false);
//                                             }
//                                         }}
//                                         className="hidden"
...
//                                                 Click to choose (optional)
//                                             </p>
//                                             {removePhoto ? (
//                                                 <p className="text-xs text-red-600 mt-1">
//                                                     Photo will be removed on update
//                                                 </p>
//                                             ) : null}
//                                         </div>
//                                     </div>
...
//                                             setPhotoFile(null);
//                                             setPhotoPreview("");
//                                             setRemovePhoto(true); // ✅ send remove_photo=1 on update
//                                         }}
//                                         className="mt-3 rounded-xl border border-black/10 px-4 py-2 text-sm font-medium hover:bg-black/5 disabled:opacity-60"
//                                     >
//                                         Remove photo
...
export default function GroupMembersPage() {
    ...
    // ✅ DELETE API: POST /admin/group-members/{id} body {}
    const deleteMember = async (id: number) => {
        ...
        try {
            ...
            if (res.data?.status) {
                ...
                setError(res.data?.message || "Failed to delete member.");
            }
        } catch (err: any) {
